...
$this->title = 'Qabul qilingan nomzodlar';
                        ...
                        <tbody>
                            ...
                            <?php foreach ($model as $index => $s) : ?>
                                ...
                                <tr>
                                    ...
                                    <?php if(!$s->description == null ):?>
                                        <td><a style=' font-size:16px;' href="<?= Url::to(['/nomzodlar/read-message', 'id' => $s->id]) ?>"><span><i class="fa fa-envelope"></i></span></a></td>
                                    <?php endif?>    
                                </tr>
